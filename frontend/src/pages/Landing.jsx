...
const Landing = () => {
  ...
  const [query, setQuery] = useState(
    "farmer in Maharashtra with income 1.5 lakhs",
  );
  ...
  console.log("fetchSchemes called");
  ...
  return (
    <div className="landing-page">
      ...
      <section className="hero-banner">
        ...
        <h1 className="banner-title">Yojana Sarthi — Citizen Scheme Portal</h1>
      ...
      <section className="scheme-finder-section">
        <div className="section-header">
          ...
          <p>
            Enter your details below to instantly check your eligibility for
        ...
        {Object.keys(schemesData.extracted_params || {}).length > 0 && (
          <div className="profile-summary-card">
            <h3>Detected Citizen Profile</h3>
        ...
        <div className="results-tabs">
          ...
          >
            ...
            Eligible Schemes ({schemesData.eligible.length})
          </button>

          <button
            className={`result-tab ${
              activeTab === "ineligible" ? "active" : ""
            }`}
            onClick={() => setActiveTab("ineligible")}
          >
            <XCircle size={18} className="icon-danger" />
            Ineligible Schemes ({schemesData.ineligible.length})
          </button>
        </div>
              ...
              (schemesData.eligible.length > 0 ? (
                schemesData.eligible.map((scheme) => (
                  ...
                  >
                    ...
                    {scheme.eligibility &&
                      scheme.eligibility !== "Information not available." && (
                    ...
                    <div className="reasons-block passed">
                      ...
                      <ul>
                        {scheme.passed_reasons?.map((reason, index) => (
                    ...
                    <div className="card-actions">
                      <button
                        ...
                        onClick={() =>
                          setExpandedScheme(
                            expandedScheme === scheme.scheme_name
                              ? null
                              : scheme.scheme_name,
                          )
                        }
                ...
                <div className="empty-state">
                  ...
                  <p>
                    Try changing Income, Occupation, Category, Age, or Search
                    Query.
                  </p>
                </div>
              ))}
            ...
            {activeTab === "ineligible" &&
              (schemesData.ineligible.length > 0 ? (
                ...
                <div className="empty-state">
                  ...
                  <p>
                    Great! Based on the information provided, there are
                    currently no schemes for which you are explicitly
                    ineligible.
                  </p>
                </div>
              ))}
        ...
        <section className="services-section">
          <div className="section-header">
            ...
            <p>
              Access essential government welfare services through one platform.
            </p>
          </div>

          <div className="services-grid">
            <div className="service-card">
              <ShieldCheck size={36} className="service-icon" />

              <h3>Eligibility Verification</h3>

              <p>
                Instantly verify your eligibility for Central and Maharashtra
                Government schemes.
              </p>
            </div>

            <div className="service-card">
              <FileText size={36} className="service-icon" />

              <h3>Required Documents</h3>

              <p>
                View all mandatory documents before applying for any government
                scheme.
              </p>
            </div>

            <div className="service-card">
              <Landmark size={36} className="service-icon" />

              <h3>Official Applications</h3>

              <p>Apply directly through the official government portals.</p>
            </div>
          </div>
        </section>
      </section>
